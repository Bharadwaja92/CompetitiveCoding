...
Coding streak means number of C's without any E or S in between. See sample test case for clarification.

Input:  First line of each file contains N - number of days.
...
n = int(input())
days = []
overdays, overdays1 = 0, 0
start, end = False, False

for i in range(n):
    s = input()
    v = longestCodingStreak(s)
    # print('v is', v, 'for', s)
    if s[-1*v:] == 'C'*v:
        # print('At ending')
        end = True
