...
for i in range(n):
    ...
    id, os, p, l, c, s = l1[0], l1[1], l1[2], l1[3], l1[4], l1[5]
    ids.append(id)
    ns = p*50 + l*5 + c*10 + s*20
    change = ns - os
    newStandings.append((id, change, ns))

# print(newStandings)

newStandings = sorted(newStandings, key=itemgetter(1, 0), reverse=True)

# print(newStandings)
#
for v in newStandings[:5]:
    print(v[0], v[2])
