...
Return the minimum time in seconds you have to spend to collect all apples in the tree, starting at vertex 0 and
...
connecting the vertices ai and bi. Additionally, there is a boolean array hasApple,
...
Output: 8
Explanation: The figure above represents the given tree where red vertices have an apple. One optimal path to collect all apples is
